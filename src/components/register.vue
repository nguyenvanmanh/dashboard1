                  ...
                  <div class="card p-4 rounded-plus bg-faded">
                    ...
                    <v-form ref="form" v-model="valid" lazy-validation>
                      ...
                      <div class="form-group">
                        <label class="form-label" for="userpassword">Username</label>
                        <v-text-field
                      ...
                      <div>
                        <label class="form-label" for="userpassword">Retype password</label>
                        <v-text-field
                          v-model="users.password_retype"
                          :rules="password_retypeRules"
                          type="password"
                          label="Password"
                          outlined
                          required
...
export default {
  ...
  data() {
    return {
      ...
      password_retypeRules: [v => !!v || "Retype your password !"],
      users: {
        firstName: "",
        lastName: "",
        email: "",
