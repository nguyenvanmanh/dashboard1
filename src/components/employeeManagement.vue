...
export default {
  ...
  methods: {
    ...
    fetAllListUser(page) {
      ...
      axios
        .get(
          `${API.BASEURL}/rest/users/list?page=${page.currentPage}&size=${page.rowPerPage}`
        )
        .then(function(response) {
          // eslint-disable-next-line
          self.users = response.data.listUser;
    ...
    fetchAllRole() {
      ...
      axios
        .get(
          `${API.BASEURL}/rest/list-all-role-with/page-no=${page}&page-size=${size}`
        )
        .then(response => {
    ...
    searchUser() {
      ...
      axios
        .get(
          `${API.BASEURL}/rest/users/search?nameField=${this.searchField}&value=${this.search}`
        )
        .then(res => {
